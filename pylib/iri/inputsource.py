...
class inputsource(object):
    ...
    def __init__(self, obj, siri=None, encoding=None, streamopenmode='rb',
        ...
        >>> from amara.iri import inputsource
        >>> inp = inputsource('abc')
        >>> inp.stream
        ...
        >>>
        '''
        # from amara.iri import inputsource; inp = inputsource('foo.zip')
        # from amara.iri import inputsource; inp = inputsource('test/resource/std-examples.zip')
