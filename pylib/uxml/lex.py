...
# FIXME: Terribly non-reentrant with use of global here.  Right now it's because the lexer is so slow to build.  Figure out how to mitigate...  # noqa: E501
# Build the lexer
...
def run(s):
    ...
    while True:
        tok = lexer.token()
        if not tok: break  # noqa: E701 # No more input
        yield tok
